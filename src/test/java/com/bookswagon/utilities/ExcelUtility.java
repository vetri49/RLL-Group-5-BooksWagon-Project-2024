...
public class ExcelUtility {
    ...
    public static void main(String[] args) {
        ...
        data.put("2", 
        		new String[]{ "Naveen N K", "Eqmd20441", "fail" }); 
        data.put("3", 
        		new String[]{ "Harshita", "vnrojfi(@u2", "pass" }); 
        data.put("4",  new String[]{"Suba Shree", "Njnfuneu9!u","pass" }); 
        data.put("5", new String[] {"Navin Kiran", "NSukohl5fc2i","pass" }); 
        data.put("6", new String[] {"Shilpha Kumari", "NSu27472s2i","pass" }); 
        data.put("7", new String[] {"Ramya Mogare", "NSu3f2s2i","pass" }); 
